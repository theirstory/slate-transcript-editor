import fs from 'fs';
import alignWords from './stt-align-node.js.js';
...
// console.log(result);
fs.writeFileSync('./src/util/restore-timcodes/stt-align-node/sample/alignement-result.sample.json', JSON.stringify(result, null, 2));
...
import { Node } from 'slate'; // importing this way, coz it runs as client side code, and the module, align-diarized-text index.js contains and import to a
...
const alignDiraizedText = require('align-diarized-text'); // TODO: this function needs to be brough into alignDiraizedText
...
const converSlateToDpe = (data, sttJson) => {
  ...
  }).flat(); // without adjusting the paragraph boundaries, can't go round trip
  ...
  return {
    words,
    paragraphs: paragraphsWithAdjustedBoundaries

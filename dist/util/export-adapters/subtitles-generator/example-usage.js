import fs from 'fs';
import subtitlesGenerator from './index.js'; // import transcript from './sample/words-list.sample.json';
...
console.log(subtitlesJson); // fs.writeFileSync('./example-output/test.json', JSON.stringify(subtitlesJson, null, 2));
